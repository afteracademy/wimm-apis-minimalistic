...
[Modern Backend Development - WhereIsMyMotivation](https://github.com/afteracademy/wimm-apis)

# Installation

```bash
# clone the repo
git clone https://github.com/afteracademy/wimm-apis-minimalistic.git
